...
export default function Listing() {
    ...
    return (
        <main>
            ...
            effect = "fade" module={[EffectFade]} autoplay={{delay: 3000}}>
            ...
            <div className='fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-grey-400
            ...
            {sharedLinkCopied && (<p className='fixed top-[23%] right-[5%] font-semibold border-2
            border-grey-400 rounded-md bg-white z-10 p-2'>Link Copied</p>)}
                ...
                <div className='w-full'>
                    ...
                    {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
                        <div className='mt-6'>
                            ...
                            duration-150 ease-in-out'>Contact Landlord</button>
                        </div>
                    )} 
